...
<body style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
     ...
     <header class="header">
        ...
        <div class="icons">
            <div class="fas fa-user" id="login-btn" a href="form1.html"> </div>
    ...
    <section class="education" >
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <p>SportsLessons is a dedicated section within Kids+ that offers young athletes an opportunity to hone their sports skills. With engaging tutorials and easy-to-follow instructions, kids can learn the fundamentals of various sports while having fun. Whether it's soccer, basketball, or tennis, SportsLessons encourages physical activity and teamwork, making it a valuable addition to our holistic learning experience.</p>
                <img src="images/education2.png" alt="">
            </div>

            <div class="box">
                <h3>drawing lessons</h3>
                <p>In the "Drawing Lessons" section of Kids+, children can unleash their artistic talents through step-by-step tutorials led by professional artists. From basic shapes to imaginative creations, this interactive feature encourages creativity and enhances fine motor skills, making learning to draw a delightful and educational experience for young artists. Let their imaginations run wild as they embark on an artistic journey with Kids+!</p>
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            ...
            <form action="#" method="post">
                ...
                <input type="submit" value="send message" name="getintouchbtn" class="btn">
            </form>
